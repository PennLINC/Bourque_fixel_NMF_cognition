...
######################
# root
root <- "/Users/joelleba/cbica/projects/pnc_fixel_cs/"
...
bundles <- c("Splenium","Fornix","Inf. CST","Int. capsule","SLF","Body of the CC","Rostrum","Sup. CST","Uncinate","SLF (parietal)","Middle CP",
